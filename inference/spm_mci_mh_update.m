function [next,accepted,bayes_fb,dL,alpha] = spm_mci_mh_update (curr,prop,verbose)
% Update parameters using Metropolis-Hastings
% FORMAT [next,accepted,bayes_fb,dL,alpha] = spm_mci_mh_update (curr,prop,verbose)
%
